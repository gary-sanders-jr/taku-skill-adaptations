---
name: personal-wip-limit-draft
description: "Use supplied, sanitized material to turn a supplied workload into a private work-in-progress limit draft; returns a private, unapplied draft only."
---

# Personal WIP Limit Draft

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to turn a supplied workload into a private work-in-progress limit draft.

## Produce

Record the supplied active work, blocked work, urgency signals, proposed limit, entry and exit rules, defer list, assumptions, and owner choices. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
