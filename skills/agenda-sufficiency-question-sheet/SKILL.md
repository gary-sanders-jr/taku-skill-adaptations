---
name: agenda-sufficiency-question-sheet
description: "Use supplied, sanitized material to review a supplied meeting purpose and agenda as a private sufficiency question sheet without cancelling, scheduling, or contacting anyone; returns a private, unapplied draft only."
---

# Agenda Sufficiency Question Sheet

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to review a supplied meeting purpose and agenda as a private sufficiency question sheet without cancelling, scheduling, or contacting anyone.

## Produce

Record the supplied purpose, intended outcomes, agenda items, evidence needs, missing decisions, dependencies, participation questions, time assumptions, risks, and NOT SCHEDULED status. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
