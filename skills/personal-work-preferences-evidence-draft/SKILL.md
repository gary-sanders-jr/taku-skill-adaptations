---
name: personal-work-preferences-evidence-draft
description: "Use supplied, sanitized material to organize supplied work preferences into a private evidence draft without monitoring, evaluating, or sharing it; returns a private, unapplied draft only."
---

# Personal Work Preferences Evidence Draft

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to organize supplied work preferences into a private evidence draft without monitoring, evaluating, or sharing it.

## Produce

Record the supplied preferences, conditions, communication patterns, focus needs, decision habits, constraints, examples, exceptions, unknowns, review questions, and NOT SHARED status. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
