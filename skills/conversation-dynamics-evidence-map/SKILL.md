---
name: conversation-dynamics-evidence-map
description: "Use supplied, sanitized material to map observable dynamics from a supplied sanitized conversation without inferring hidden mental states; returns a private, unapplied draft only."
---

# Conversation Dynamics Evidence Map

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to map observable dynamics from a supplied sanitized conversation without inferring hidden mental states.

## Produce

Record the supplied excerpts, explicit statements, participation patterns as represented, topic shifts, questions, tensions, alternative interpretations, missing context, and human review. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
