---
name: overthinking-constraint-question-note
description: "Use supplied, sanitized material to turn supplied overthinking context into a private constraint-and-question note without deciding for the user; returns a private, unapplied draft only."
---

# Overthinking Constraint Question Note

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to turn supplied overthinking context into a private constraint-and-question note without deciding for the user.

## Produce

Record the supplied question, desired outcome, constraints, repeated loops, known facts, assumptions, smallest decision boundary, unresolved questions, and owner judgment. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
