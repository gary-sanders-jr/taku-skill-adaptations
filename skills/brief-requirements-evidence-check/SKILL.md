---
name: brief-requirements-evidence-check
description: "Use supplied, sanitized material to check a supplied brief against supplied requirements in a private evidence sheet without drafting a response or submitting materials; returns a private, unapplied draft only."
---

# Brief Requirements Evidence Check

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to check a supplied brief against supplied requirements in a private evidence sheet without drafting a response or submitting materials.

## Produce

Record the supplied requirement, matching excerpt, coverage label, stated constraint, dependency, conflict, missing evidence, clarification question, owner, and NOT SUBMITTED status. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
