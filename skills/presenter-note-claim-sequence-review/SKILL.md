---
name: presenter-note-claim-sequence-review
description: "Use supplied, sanitized material to review the claim sequence in supplied presenter notes in a private evidence note without creating slides or presenting; returns a private, unapplied draft only."
---

# Presenter Note Claim Sequence Review

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to review the claim sequence in supplied presenter notes in a private evidence note without creating slides or presenting.

## Produce

Record the supplied audience, objective, claim sequence, evidence references, transitions, assumptions, missing support, timing labels as supplied, questions, and NOT PRESENTED status. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
