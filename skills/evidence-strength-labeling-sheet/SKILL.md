---
name: evidence-strength-labeling-sheet
description: "Use supplied, sanitized material to label the support relationships in supplied material in a private sheet without external validation, scoring people, or approving conclusions; returns a private, unapplied draft only."
---

# Evidence Strength Labeling Sheet

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to label the support relationships in supplied material in a private sheet without external validation, scoring people, or approving conclusions.

## Produce

Record each supplied claim, evidence excerpt, relevance, directness, scope, limitations, contradictions, uncertainty label, missing support, and NOT EXTERNALLY VERIFIED status. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
