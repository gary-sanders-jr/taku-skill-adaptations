---
name: research-protocol-evidence-draft
description: "Use supplied, sanitized material to organize a supplied research question into a private protocol draft without recruiting, collecting data, or running research; returns a private, unapplied draft only."
---

# Research Protocol Evidence Draft

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to organize a supplied research question into a private protocol draft without recruiting, collecting data, or running research.

## Produce

Record the supplied question, scope, inclusion criteria, evidence types, proposed method, variables or themes, ethics and privacy questions, stopping rule, limitations, and NOT RUN status. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
