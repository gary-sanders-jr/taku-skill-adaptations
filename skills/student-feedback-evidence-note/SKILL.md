---
name: student-feedback-evidence-note
description: "Use supplied, sanitized material to organize supplied learning evidence into a private feedback note without grading, diagnosing, or contacting a student; returns a private, unapplied draft only."
---

# Student Feedback Evidence Note

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to organize supplied learning evidence into a private feedback note without grading, diagnosing, or contacting a student.

## Produce

Record the supplied learning objective, observed work, strengths, gaps, evidence excerpts, uncertainty, neutral questions, practice proposals, support boundaries, and NOT SENT status. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
