---
name: decision-rationale-explanation-note
description: "Use supplied, sanitized material to explain the reasoning represented in supplied decision material without endorsing or changing the decision; returns a private, unapplied draft only."
---

# Decision Rationale Explanation Note

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to explain the reasoning represented in supplied decision material without endorsing or changing the decision.

## Produce

Record the supplied decision, stated reasons, implied assumptions, trade-offs, evidence strength, uncertainties, alternative interpretations, and questions for the decision owner. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
