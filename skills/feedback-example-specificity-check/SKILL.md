---
name: feedback-example-specificity-check
description: "Use supplied, sanitized material to check supplied feedback statements for specific supporting examples in a private note without grading, rewriting, or delivering feedback; returns a private, unapplied draft only."
---

# Feedback Example Specificity Check

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to check supplied feedback statements for specific supporting examples in a private note without grading, rewriting, or delivering feedback.

## Produce

Record the supplied feedback claim, example excerpt, observed behavior, impact claim, qualifier, generalization risk, missing context, question, owner choice, and NOT DELIVERED status. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
