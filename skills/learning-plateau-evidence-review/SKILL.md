---
name: learning-plateau-evidence-review
description: "Use supplied, sanitized material to review supplied non-clinical learning-performance observations in a private plateau evidence note without testing, grading, or scheduling practice; returns a private, unapplied draft only."
---

# Learning Plateau Evidence Review

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to review supplied non-clinical learning-performance observations in a private plateau evidence note without testing, grading, or scheduling practice.

## Produce

Record the supplied skill goal, practice history, performance evidence, recurring errors, assumptions, constraints, variation proposals, review criteria, unknowns, and NOT PRACTICED status. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
