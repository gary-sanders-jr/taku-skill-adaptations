---
name: document-output-requirements-sheet
description: "Use supplied, sanitized material to extract document-output requirements from supplied instructions into a private sheet without opening, creating, or formatting a document; returns a private, unapplied draft only."
---

# Document Output Requirements Sheet
