---
name: source-triangulation-map
description: "Use supplied, sanitized material to map agreement and conflict across supplied source excerpts without retrieving any source; returns a private, unapplied draft only."
---

# Source Triangulation Map

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to map agreement and conflict across supplied source excerpts without retrieving any source.

## Produce

Record the supplied sources, shared claims, differences, independence assumptions, gaps, confidence limits, and follow-up questions. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
