---
name: research-protocol-draft
description: "Use supplied, sanitized material to turn a supplied research question and constraints into a private protocol draft; returns a private, unapplied draft only."
---

# Research Protocol Draft

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to turn a supplied research question and constraints into a private protocol draft.

## Produce

Record the question, scope, inclusion and exclusion rules, supplied evidence plan, extraction fields, stopping rule, limitations, and owner decisions. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
