---
name: starting-point-evidence-map
description: "Use supplied, sanitized material to turn a supplied ambiguous objective into a private starting-point evidence map without initiating or assigning work; returns a private, unapplied draft only."
---

# Starting Point Evidence Map

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to turn a supplied ambiguous objective into a private starting-point evidence map without initiating or assigning work.

## Produce

Record the supplied objective, current state, known facts, assumptions, constraints, prerequisites, smallest proposed starting point, validation evidence, unknowns, and NOT STARTED status. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
