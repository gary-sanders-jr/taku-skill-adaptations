---
name: teaching-objective-evidence-alignment
description: "Use supplied, sanitized material to compare supplied teaching objectives and explanation material in a private evidence map without presenting or persuading; returns a private, unapplied draft only."
---

# Teaching Objective Evidence Alignment

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to compare supplied teaching objectives and explanation material in a private evidence map without presenting or persuading.

## Produce

Record the supplied audience, objective, prior knowledge assumptions, explanation claims, examples, evidence, comprehension checks as supplied, gaps, questions, and NOT TAUGHT status. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
