---
name: exam-preparation-evidence-plan
description: "Use supplied, sanitized material to organize supplied exam scope and constraints into a private preparation plan without accessing courses or scheduling study sessions; returns a private, unapplied draft only."
---

# Exam Preparation Evidence Plan

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to organize supplied exam scope and constraints into a private preparation plan without accessing courses or scheduling study sessions.

## Produce

Record the supplied exam scope, date as stated, topics, current confidence, evidence of gaps, practice ideas, proposed sequence, checkpoints, risks, and NOT SCHEDULED status. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
