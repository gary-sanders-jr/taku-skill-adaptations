---
name: decision-forensics-question-map
description: "Use supplied, sanitized material to map questions around a supplied decision record without investigating external systems or assigning blame; returns a private, unapplied draft only."
---

# Decision Forensics Question Map

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to map questions around a supplied decision record without investigating external systems or assigning blame.

## Produce

Record the supplied decision record, timeline as represented, actors as described, evidence links as inert text, inconsistencies, unanswered questions, alternative explanations, and human follow-up. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
