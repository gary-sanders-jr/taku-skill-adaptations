---
name: citation-hygiene-evidence-check
description: "Use supplied, sanitized material to review supplied citation entries and claim links in a private hygiene check without validating external sources; returns a private, unapplied draft only."
---

# Citation Hygiene Evidence Check

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to review supplied citation entries and claim links in a private hygiene check without validating external sources.

## Produce

Record the supplied claim, citation entry, claim-to-source link as represented, missing fields, consistency issues, unverifiable points, limitations, and owner follow-up. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
