---
name: async-update-evidence-synthesis
description: "Use supplied, sanitized material to synthesize supplied asynchronous updates into a private evidence note without reading channels, assigning work, or sending a summary; returns a private, unapplied draft only."
---

# Async Update Evidence Synthesis

Use this skill only with sanitized material the user supplies in the current conversation. Its purpose is to synthesize supplied asynchronous updates into a private evidence note without reading channels, assigning work, or sending a summary.

## Produce

Record the supplied updates, completed work as stated, in-progress work, blockers, dependencies, decisions, inconsistencies, unknowns, owner questions, and NOT SENT status. Preserve qualifiers, distinguish supplied facts from assumptions, and label missing support as `unknown`. Keep the result private and unapplied.
